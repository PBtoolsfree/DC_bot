...
from bot.database.models.verification import VerificationSettings, VerificationSession, VerificationHistory
...
class VerificationService:
    ...
    async def _apply_success_roles(self, member: discord.Member, settings: VerificationSettings) -> None:
    ...
    async def _log_history(self, session: AsyncSession, v_session: VerificationSession, result: str) -> None:
