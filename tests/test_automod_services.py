...
class TestProfanityService:
    ...
    async def test_bad_words(
        self, service: ProfanityService, mock_message: MagicMock, base_settings: AutoModSettings
    ) -> None:
        base_settings.words_profanity = RuleConfig(enabled=True, blacklist=["badword"])
...
class TestLinkService:
    ...
    async def test_discord_invites(
        self, service: LinkService, mock_message: MagicMock, base_settings: AutoModSettings
    ) -> None:
    ...
    async def test_external_whitelist(
        self, service: LinkService, mock_message: MagicMock, base_settings: AutoModSettings
    ) -> None:
...
class TestSpamService:
    ...
    async def test_caps_spam(
        self, service: SpamService, mock_message: MagicMock, base_settings: AutoModSettings
    ) -> None:
