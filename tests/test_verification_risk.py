...
async def test_calculate_risk_high() -> None:
    ...
    # Created 1 hour ago
    mock_member.created_at = datetime.datetime.now(datetime.timezone.utc) - datetime.timedelta(hours=1)
...
async def test_calculate_risk_low() -> None:
    ...
    mock_member = MagicMock()
    # Created 3 years ago
    mock_member.created_at = datetime.datetime.now(datetime.timezone.utc) - datetime.timedelta(days=1000)
